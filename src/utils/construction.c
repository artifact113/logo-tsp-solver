...
vector<ROUTE_DATA_TYPE> multipleFragment(ROUTE_DATA_TYPE cities, city_coords* coords) {
...
ROUTE_DATA_TYPE getNNSimple(ROUTE_DATA_TYPE index, city_coords* coords, ROUTE_DATA_TYPE cities)  {
...
void routeInit(vector<ROUTE_DATA_TYPE> &route, int method, ROUTE_DATA_TYPE size, city_coords* coords) {
...
void checkTour (vector <ROUTE_DATA_TYPE> route) {
